...
inputs session-context-mutation scripts/check-session-context.sh scripts/check-lib.sh scripts/lib/common.sh scripts/lib/cleanup-lib.sh scripts/lib/run-state.sh agents/claude/scripts/session-context.sh agents/claude/settings.hooks.json base/workflows/implement-issue.md
