...
#   artifacts: <path>, …                                 (gaps/review/docs/survey/rules records, the first 400 by path)
...
# _rs_scan <dir> — `state-scan` once; sets RS_ARTS (gaps/review/docs/survey/rules paths, sorted, comma-joined),
