...
| **2 — deferred to the PR layer** | no in-session slot is usable, **but** `{{ROLE_DISPATCH}} bots` lists an async reviewer | mark the slot **deferred**, say so, and proceed to the PR. |
